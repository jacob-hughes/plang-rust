...
fn main() {
    ...
    //FIXME: Unhardcode these paths
    let lex_path    = Path::new("/home/jake/projects/plang_interp/grammar/lexer.l");
    let yacc_path   = Path::new("/home/jake/projects/plang_interp/grammar/grammar.y");
